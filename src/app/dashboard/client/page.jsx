...
export default function ClientDetails() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!client.name || !client.address || !client.gstNumber || !client.phone) {
      alert("Please fill all fields");
      return;
    }
    setClients([...clients, client]);
    setClient({ name: "", address: "", gstNumber: "", phone: "" });
    setShowForm(false);
  };
    ...
    <div className="min-h-screen bg-gray-800 text-black p-4 flex flex-col items-center">
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-2xl p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-blue-700">Client Details</h2>
              ...
              <tbody>
                {clients.map((c, index) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-300 px-4 py-2">{c.address}</td>
                    <td className="border border-gray-300 px-4 py-2">{c.gstNumber}</td>
